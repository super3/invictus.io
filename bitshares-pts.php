   ...
   <script src="assets/js/pts.prices.js"></script>
    ...
    <center> <img style="margin-left:40px" src='assets/img/ptslogo.png' width='600'> </img> </center>
			<div class="inner-page row">
              ...
              decentralized autonomous company and Invictus has many innovative blockchains on our road-map.
							</p>
              <p>
              ...
              <div class="pts-resources">
                    <h3> Mining Pools</h3>
                      ...
                      connected nodes and pays you proportionally for your share rate. See our <a href="mining.html">mining guide</a> for more explanation. Most pools have their own optimized miners, so do check out their get started pages.</p>
                      ...
                      <ul style="list-style-type: circle;">
                        ...
                        <li><a href="http://ypool.net">http://ypool.net</a> -  6% fee, multiple coin pool,  Pay Per Share</li>
                      </ul>
