...
var flipCounter = function(d, options){
	...
	function addDigit(len, digit){
		...
		//alert("digit ' + digit ' is in position ' + li);
	...
	function initialDigitCheck(init){
		...
		for (i = 0; i < count; i++){
			...
			newDigit.innerHTML = '<li class="dollar"></li>';
			newDigit.innerHTML = newDigit.innerHTML = '<li class="t" id="' + divId + '_t_d' + i + '"></li><li class="b" id="' + divId + '_b_d' + i + '"></li>';
			div.insertBefore(newDigit, div.firstChild);
			if (bit == 2 ) {
				newComma = doc.createElement("ul");
				newComma.className = 'cd';
				newComma.innerHTML = '<li class="decimal"></li>';
				div.insertBefore(newComma, div.firstChild);
			}

			if (bit != (count) && digit != 0 && digit % 3 == 0){
				newComma = doc.createElement("ul");
				newComma.className = 'cd';
				newComma.innerHTML = '<li class="s"></li>';
				div.insertBefore(newComma, div.firstChild);
		...
		// Prints out the dollar sign before everything else
		dollarSign = doc.createElement("ul");
		dollarSign.className = 'cd';
		dollarSign.innerHTML = '<li class="dollar"></li><li class="space"></li>';
		div.insertBefore(dollarSign, div.firstChild);
