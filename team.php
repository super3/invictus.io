		...
		<div class="row mt centered">	
			...
			<div class="col-lg-4 desc">
				...
				<p style="text-align: justify;">
					...
					At Texas Instruments he worked as both a software design engineer and a hardware design engineer. 
					Notestein also worked at Burr Brown Corporation, where he was project leader for the design of a custom VXI-based test system for high-performance analog ICs.
			...
			<div class="col-lg-4 desc">
				...
				<p style="text-align: justify;">
					...
					C. and Linux expert. He is also a researcher at the field of Machine Learning Theory.
					In addition, studied psychology, physics and philosophy, and has a great deal with technological innovations. 
					Ohad strongly believes in justice for all, and is an enthusiastic member of the Open Source and crypto-currency communities. 
