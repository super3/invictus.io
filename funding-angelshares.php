				...
				<div class="row">				
					<div class="col-lg-8">					
						<h3>What are Angelshares?</h3>					
							<p style="text-align: justify;">								
								AngelShares, like ProtoShares, represent a way to gain a stake in the new crypto-equity industry.  
								ProtoShares acknowledge a contribution to the launch of the new industry, representing a proof of work done in generating public interest.  
								AngelShares acknowledge an equally important financial contribution to the industry infrastructure.
							</p>
						...
						<h3>How to acquire Angelshares?</h3>					
							<p style="text-align: justify;">								
								Beginning New Year’s Day 2014, there will be 10,000 new AngelShares available in a new patron competition, every day, for 200 days. 
					...
					<div class="col-lg-4" style="padding-top: 25px;">
						<div class="headerimgholder">
							<img src="assets/img/AngelShares.png">
						</div>
					</div>					
				</div>	
				<br><br>
